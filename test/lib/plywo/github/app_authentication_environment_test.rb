...
class PlywoGithubAppAuthenticationEnvironmentTest < ActiveSupport::TestCase
  test "from_env honors the GitHub API base URL" do
    ...
    authentication = Plywo::Github::AppAuthentication.from_env(root: "/srv/plywo")

    assert_equal "12345", authentication.instance_variable_get(:@app_id)
    assert_equal "/srv/plywo/tmp/lab-app.pem", authentication.instance_variable_get(:@private_key_path)
