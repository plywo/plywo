...
class OnboardingControllerTest < ActionDispatch::IntegrationTest
  test "renders the configured GitHub App install path and minimal Rails contract" do
    previous_slug = ENV["PLYWO_GITHUB_APP_SLUG"]
    ENV["PLYWO_GITHUB_APP_SLUG"] = "plywo-development"

    get onboarding_url(installation_id: "untrusted-installation-id")

    assert_response :success
    assert_includes response.body, "https://github.com/apps/plywo-development/installations/new"
    ...
    ENV["PLYWO_GITHUB_APP_SLUG"] = previous_slug
  end

  test "uses the development App slug by default outside production" do
    previous_slug = ENV.delete("PLYWO_GITHUB_APP_SLUG")
    previous_environment = ENV.delete("PLYWO_GITHUB_APP_MANIFEST_ENV")
  ...
  test "rejects an invalid configured GitHub App slug" do
    previous_slug = ENV["PLYWO_GITHUB_APP_SLUG"]
    ENV["PLYWO_GITHUB_APP_SLUG"] = "https://example.test/not-a-slug"

    get onboarding_url

    assert_response :unprocessable_entity
    assert_includes response.body, "invalid PLYWO_GITHUB_APP_SLUG"
  ensure
    ENV["PLYWO_GITHUB_APP_SLUG"] = previous_slug
  end
end
